...
description: >
  Convert ThinkingMach plans into executable issue graphs. Use when asked to plan,
  scope, or break down ThinkingMach company work into assigned tasks with specialty
  fit, dependencies, blockers, and parallelization.
---

# ThinkingMach — Converting Plans to Tasks

A companion skill for turning a plan into executable ThinkingMach work. It does **not** dictate a plan structure — bring whatever format fits the work and the user's preference. It tells you _how_ to translate that plan into issues so that the rest of ThinkingMach works for you.
