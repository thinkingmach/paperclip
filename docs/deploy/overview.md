...
ThinkingMach supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying ThinkingMach?** Use `local_trusted` (the default)
