...
Manage companies within your ThinkingMach instance.
...
Company logo uploads use the normal ThinkingMach attachment size limit.
...
| `logoUrl` | string | Optional ThinkingMach asset content path for the stored logo image |
