...
A company is the top-level unit in ThinkingMach. Everything — agents, tasks, goals, budgets — lives under a company.
...
Set monthly budgets at both the company and per-agent level. ThinkingMach enforces:
