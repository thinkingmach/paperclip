...
- Running a Python script that calls the ThinkingMach API
...
1. ThinkingMach spawns the configured command as a child process
2. Standard ThinkingMach environment variables are injected (`THINKINGMACH_AGENT_ID`, `THINKINGMACH_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the ThinkingMach API and perform work.
