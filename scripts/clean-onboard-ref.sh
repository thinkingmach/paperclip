...
Environment overrides:
  ...
  PC_DATA=/tmp/data           ThinkingMach data dir to use
  THINKINGMACH_HOST=127.0.0.1    Host passed to the onboarded server
  THINKINGMACH_PORT=3232         Port passed to the onboarded server
...
export THINKINGMACH_HOST="${THINKINGMACH_HOST:-127.0.0.1}"
export THINKINGMACH_PORT="${THINKINGMACH_PORT:-3100}"
export THINKINGMACH_OPEN_ON_LISTEN="${THINKINGMACH_OPEN_ON_LISTEN:-false}"
...
echo "THINKINGMACH_HOST: $THINKINGMACH_HOST"
echo "THINKINGMACH_PORT: $THINKINGMACH_PORT"
...
env \
  ...
  HOST="$THINKINGMACH_HOST" \
  PORT="$THINKINGMACH_PORT" \
  THINKINGMACH_OPEN_ON_LISTEN="$THINKINGMACH_OPEN_ON_LISTEN" \
