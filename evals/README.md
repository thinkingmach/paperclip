...
Eval framework for testing ThinkingMach agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the ThinkingMach heartbeat skill:
