 ...
 * the ThinkingMach service layer.
 *
...
export function pluginRegistryService(db: Db) {
  ...
  return {
     ...
     */
    install: async (input: InstallPlugin, manifest: ThinkingMachPluginManifestV1) => {
    ...
    /**
     * Create or update a persistent mapping between a ThinkingMach object and an
     * external entity.
     *
     * @param pluginId - The UUID of the plugin.
