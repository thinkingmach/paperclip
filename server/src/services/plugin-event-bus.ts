/**
 * PluginEventBus — typed in-process event bus for the ThinkingMach plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@thinkingmach/shared";
import type { PluginEvent, EventFilter } from "@thinkingmach/plugin-sdk";
