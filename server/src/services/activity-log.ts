...
import { activityLog, agentApiKeys, companies, heartbeatRuns, issues } from "@thinkingmach/db";
import { isUuidLike, PLUGIN_EVENT_TYPES, type PluginEventType } from "@thinkingmach/shared";
import type { PluginEvent } from "@thinkingmach/plugin-sdk";
