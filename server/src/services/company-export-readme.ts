 ...
 */
import type { CompanyPortabilityManifest } from "@thinkingmach/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [ThinkingMach](https://thinkingmach.com)");
  lines.push("");
