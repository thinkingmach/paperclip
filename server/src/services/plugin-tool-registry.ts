...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@thinkingmach/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: ThinkingMachPluginManifestV1, pluginDbId: string): void;
