...
import { pluginManifestV1Schema, type ThinkingMachPluginManifestV1 } from "@thinkingmach/shared";
import { pluginCapabilityValidator } from "../services/plugin-capability-validator.js";

const baseManifest: ThinkingMachPluginManifestV1 = {
...
describe("plugin environment driver seam", () => {
  ...
  it("enforces environment driver capability requirements", () => {
    ...
    const withoutCapability = {
      ...baseManifest,
      capabilities: ["http.outbound"],
    } satisfies ThinkingMachPluginManifestV1;
...
const objectReferenceManifest: ThinkingMachPluginManifestV1 = {
