...
describe("cursor local skill sync", () => {
  ...
  it("defaults and installs the operational ThinkingMach skill in the Cursor skills home", async () => {
  ...
  it("recognizes company-library runtime skills supplied outside the bundled ThinkingMach directory", async () => {
