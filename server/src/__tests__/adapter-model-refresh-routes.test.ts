...
function registerModuleMocks() {
  vi.doMock("@thinkingmach/adapter-opencode-local/server", async () => {
    const actual = await vi.importActual<typeof import("@thinkingmach/adapter-opencode-local/server")>("@thinkingmach/adapter-opencode-local/server");
    return {
      ...actual,
