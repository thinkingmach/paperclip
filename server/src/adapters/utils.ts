...
export type { RunProcessResult } from "@thinkingmach/adapter-utils/server-utils";
...
export const buildThinkingMachEnv = serverUtils.buildThinkingMachEnv;
export const buildRuntimeToolsEnv = serverUtils.buildRuntimeToolsEnv;
export const isThinkingMachRuntimeEnvKey = serverUtils.isThinkingMachRuntimeEnvKey;
...
export function buildInvocationEnvForLogs(
  ...
  if (resolvedCommand) {
    merged[options.resolvedCommandEnvKey ?? "THINKINGMACH_RESOLVED_COMMAND"] =
