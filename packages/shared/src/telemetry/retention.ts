 ...
 *
 * Defines the retention class for each ThinkingMach telemetry event and the
 ...
 * that are not part of the shared generated `ThinkingMachEventName` type. When an
 ...
 *   External-system event (Codex CLI) — not yet in ThinkingMachEventName.
