...
import { ensurePathInEnv } from "@thinkingmach/adapter-utils/server-utils";
...
async function readSandboxCursorRuntimeInfo(input: {
  ...
  const homeMarker = "__THINKINGMACH_CURSOR_HOME__:";
  const preferredMarker = "__THINKINGMACH_CURSOR_AGENT__:";
  try {
