...
/**
 * Parse Hermes Agent stdout into TranscriptEntry objects for the ThinkingMach UI.
 *
 ...
 *   System:     "[hermes] ..."
 *
 * We emit structured tool_call/tool_result pairs so ThinkingMach renders proper
 ...
 * ThinkingMach uses this to match them in normalizeTranscript.
 */
 ...
 * ThinkingMach renders proper tool cards with status icons and expand/collapse.
 *
...
export function parseHermesStdoutLine(
  ...
  // Emit as stderr so ThinkingMach groups them into the amber accordion.
