...
describe("paperclip-task-bridge helper", () => {
  ...
  function env() {
    return {
      THINKINGMACH_API_URL: baseUrl,
      THINKINGMACH_BRIDGE_API_KEY: apiKey,
      THINKINGMACH_COMPANY_ID: "22222222-2222-4222-8222-222222222222",
      THINKINGMACH_AGENT_ID: "11111111-1111-4111-8111-111111111111",
      THINKINGMACH_RUN_ID: "66666666-6666-4666-8666-666666666666",
    };
  }
