...
const manifest: ThinkingMachPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current ThinkingMach plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "ThinkingMach",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the ThinkingMach domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
