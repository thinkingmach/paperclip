/**
 * `@thinkingmach/plugin-sdk/ui` — ThinkingMach plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@thinkingmach/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@thinkingmach/plugin-sdk/ui";
 *
 ...
 * - `useHostNavigation()` — navigate ThinkingMach-internal links through the host router
