 ...
 *
 * These components are exported from `@thinkingmach/plugin-sdk/ui` and are
 ...
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components In `@thinkingmach/plugin-sdk/ui`
 */
...
function createSdkUiComponent<TProps>(name: string): React.ComponentType<TProps> {
  return function ThinkingMachSdkUiComponent(props: TProps) {
...
/**
 * Renders ThinkingMach's shared Markdown editor.
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components
 */
...
/**
 * Renders ThinkingMach's native issue list component for company-scoped plugin
...
/**
 * Renders ThinkingMach's native managed routines list for plugin settings pages.
 */
