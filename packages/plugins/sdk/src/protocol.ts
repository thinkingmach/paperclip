 ...
 * channel.
 *
 * The ThinkingMach plugin runtime uses JSON-RPC 2.0 over stdio to communicate
...
export type { PluginLauncherRenderContextSnapshot } from "@thinkingmach/shared";
 ...
 * we use strings (UUIDs or monotonic counters) for all ThinkingMach messages.
 */
...
/**
 * ThinkingMach plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this ThinkingMach instance. */
    instanceId: string;
    /** Semver version of the running ThinkingMach host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
...
export interface PluginPerformActionActorContext {
  /** Authenticated principal type resolved by the ThinkingMach host. */
