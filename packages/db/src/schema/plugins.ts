...
import type { PluginCategory, PluginStatus, ThinkingMachPluginManifestV1 } from "@thinkingmach/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<ThinkingMachPluginManifestV1>().notNull(),
