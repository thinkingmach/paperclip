...
function renderHandoff() {
  return [
    ...
    "## Stable Inputs",
    "",
    "- `capabilities.yaml`: every current ThinkingMach skill and reference heading, including its source anchor, disposition, semantic operation, and mock-state expectation.",
