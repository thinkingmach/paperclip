...
| Import | Purpose |
| --- | --- |
| `@thinkingmach/paperclip-runner` | Protocol, reducer, and existing package contracts |
| `@thinkingmach/paperclip-runner/browser` | Framework-free HTTP/SSE client, protocol types, transcript projection |
| `@thinkingmach/paperclip-runner/react` | Hook, reference console, and reusable React components |
| `@thinkingmach/paperclip-runner/styles.css` | Scoped light-theme token and component styles |
...
```ts
import { createRunnerClient } from "@thinkingmach/paperclip-runner/browser";
...
```tsx
import { useRunnerConsole } from "@thinkingmach/paperclip-runner/react";
