...
Conformance is the smallest standalone runner path. It uses a mock control plane and does not start ThinkingMach.
...
```sh
pnpm --filter @thinkingmach/paperclip-runner check:conformance-parity
```
