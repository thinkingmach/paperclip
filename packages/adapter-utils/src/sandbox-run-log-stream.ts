...
const TAIL_MARKER_STDOUT = "__THINKINGMACH_RUN_LOG_STDOUT__";
const TAIL_MARKER_STDERR = "__THINKINGMACH_RUN_LOG_STDERR__";
const TAIL_MARKER_END = "__THINKINGMACH_RUN_LOG_END__";
