...
- [ ] `npm view thinkingmach@canary version` matches the expected canary
...
- [ ] `npm view thinkingmach@nightly version` shows the new `-nightly.N`
...
- [ ] `npm view thinkingmach@beta version` shows the new `-beta.N`
...
- [ ] `npm view thinkingmach version` (dist-tag `latest`) shows the stable
