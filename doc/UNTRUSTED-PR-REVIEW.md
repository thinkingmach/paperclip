...
This is intentionally separate from the normal ThinkingMach dev image.
...
```sh
review-checkout-pr thinkingmach/paperclip 432
cd /work/checkouts/thinkingmach-paperclip/pr-432
```
...
## Preview the ThinkingMach app from the PR
...
- ThinkingMach's embedded PostgreSQL and local storage stay inside the container home volume via `THINKINGMACH_HOME=/home/reviewer/.paperclip-review`.
