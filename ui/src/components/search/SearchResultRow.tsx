...
import { Bot, FileText, Hexagon, MessageSquare, ThinkingMach, Quote } from "lucide-react";
import type { Agent, CompanySearchResult } from "@thinkingmach/shared";
...
const SNIPPET_STYLES: Record<string, SnippetStyle> = {
  ...
  artifact: { Icon: ThinkingMach, label: "Artifact" },
...
function SearchResultRowImpl({
  ...
  if (result.type === "artifact") {
    ...
    return (
      ...
      >
        <ThinkingMach className="mt-1 h-4 w-4 shrink-0 text-muted-foreground" />
        <div className="min-w-0 flex-1">
