...
export const sampleTeam: CatalogTeam = {
  id: "thinkingmach:bundled:company-defaults:core-exec-team",
  ...
  packageName: "@thinkingmach/teams-catalog",
  packageVersion: "0.1.0",
};

export const optionalTeam: CatalogTeam = {
  ...sampleTeam,
  id: "thinkingmach:optional:software-development:platform-pod",
  key: "thinkingmach/optional/software-development/platform-pod",
  kind: "optional",
...
export const warnTeam: CatalogTeam = {
  ...sampleTeam,
  id: "thinkingmach:optional:research:lab-with-local-source",
...
export const onboardingTeams: CatalogTeam[] = [
  ...
  {
    ...sampleTeam,
    id: "thinkingmach:bundled:company-defaults:growth-pod",
    key: "thinkingmach/bundled/company-defaults/growth-pod",
    slug: "growth-pod",
    name: "Growth Pod",
    description:
  ...
  {
    ...sampleTeam,
    id: "thinkingmach:bundled:company-defaults:support-pod",
    key: "thinkingmach/bundled/company-defaults/support-pod",
    slug: "support-pod",
    name: "Support Pod",
