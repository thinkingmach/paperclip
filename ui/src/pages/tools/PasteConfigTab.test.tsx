...
import type { ConnectToolAppResult, McpJsonImportPreview } from "@thinkingmach/shared";
        ...
        drafts: [
          {
            ...
            warnings: ["Header Authorization will be stored as a ThinkingMach secret before activation."],
          },
        ],
      },
