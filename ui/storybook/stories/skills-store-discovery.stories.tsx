...
const MOCK_CARDS: DiscoveryCard[] = [
  {
    key: "thinkingmach/paperclip/paperclip-dev",
    skillId: "s-dev",
    catalogRef: null,
    name: "paperclip-dev",
    slug: "paperclip-dev",
    author: "ThinkingMach",
    version: "v2.4.1",
    tagline: "Run and repair local ThinkingMach workspaces.",
    description: "Develop and operate a local ThinkingMach instance.",
  ...
  {
    key: "thinkingmach/paperclip/verify",
    skillId: "s-verify",
    catalogRef: null,
    name: "verify",
    slug: "verify",
  ...
  {
    key: "thinkingmach/paperclip/security-review",
    skillId: "s-sec",
    catalogRef: null,
  ...
  {
    key: "thinkingmach/paperclip/diagnose-why-work-stopped",
    skillId: "s-diag",
    catalogRef: "c-diag",
