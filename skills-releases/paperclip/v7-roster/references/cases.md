...
Agent run writes auto-link the run's issue when ThinkingMach can resolve it from
the run JWT or `X-ThinkingMach-Run-Id`. Creation/upsert writes use `origin`; later
...

{
  ...
  "title": "Introducing ThinkingMach Cases",
...

{
  "title": "Introducing ThinkingMach Cases",
  "format": "markdown",
  "body": "# Introducing ThinkingMach Cases\n\n..."
}
```
...

{
  ...
  "title": "Image assets for Introducing ThinkingMach Cases",
  "parentCaseId": "parent-case-uuid",
  "status": "in_progress",
  "fields": {
    "slug": "paperclip-cases-launch",
